...
// Getting photo for user profile
class UserDialogImageFragment: DialogFragment(), DialogInterface.OnClickListener   {
    private lateinit var addImgDialogView: View
    private val imgFileName = "userprofile_img.jpg"
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        addImgDialogView =
            requireActivity().layoutInflater.inflate(
                R.layout.fragment_image_dialog_user,
                null)
    ...
    private fun handleResults() {
        cameraResult = registerForActivityResult(ActivityResultContracts.StartActivityForResult())
        {
            if (it.resultCode == Activity.RESULT_OK) {
                ...
                userProfileViewModel.image.value = bitmap
